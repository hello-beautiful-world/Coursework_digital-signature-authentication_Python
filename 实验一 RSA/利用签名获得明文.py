...
返回值:x-攻击所获明文
''' 
def getx_usingSign(c,e,n,d):
    r=random.randint(2,10)#选择一个小的随机数r
    s=fast_mod(r,e,n)
    l=(s*c)%n
    t= mod_inverse(r, n)
    #让接收者对l签名
...
m=int(m1)
#加密
ciphertext1=RSA_encryption(m,receiver_n,receiver_e)
#攻击
x=getx_usingSign(ciphertext1,receiver_e,receiver_n,receiver_d)
print(f"攻击所得明文为{x}")
